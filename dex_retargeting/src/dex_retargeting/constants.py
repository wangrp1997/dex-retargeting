...
ROBOT_NAME_MAP = {
    ...
    RobotName.botyard: "botyard_hand",
}
...
def get_default_config_path(
    ...
    # 使用 src 目录下的配置文件
    config_path = Path(os.path.expanduser("~/ros2_ws/src/ros2_botyard/dex_retargeting/dex_retargeting/src/dex_retargeting/configs"))
