...
from dex_retargeting.src.dex_retargeting.yourdfpy import DUMMY_JOINT_NAMES
...
class RetargetingConfig:
    ...
    def build(self) -> 'SeqRetargeting':
        from dex_retargeting.src.dex_retargeting.optimizer import (
            VectorOptimizer,
            PositionOptimizer,
            DexPilotOptimizer,
        )
        from dex_retargeting.src.dex_retargeting.seq_retarget import SeqRetargeting
        import tempfile
